...
class ExpenseForm(forms.ModelForm):
	...
	category = forms.CharField(max_length=64, required=False, widget=forms.HiddenInput()) #what category the description is a part of
	...
	name = forms.CharField(max_length=32, help_text="")
